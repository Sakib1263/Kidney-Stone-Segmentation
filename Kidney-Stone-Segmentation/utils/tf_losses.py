...
class TFLosses:
    ...
    def loss(self):
        if self.loss_function_name == "BinaryCrossentropy":
            ...
            loss = tf.keras.losses.BinaryFocalCrossentropy(apply_class_balancing=True, alpha=0.25, gamma=2.0, from_logits=False, label_smoothing=0.0, axis=-1, name='binary_focal_crossentropy')
        ...
        elif self.loss_function_name == "Dice":
